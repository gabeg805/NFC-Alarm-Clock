 ...
 */
public class NacDayButtonStylePreference
	extends Preference
	implements Preference.OnPreferenceClickListener
{
	...
	/**
	 */
	public NacDayButtonStylePreference(Context context, AttributeSet attrs)
	{
	...
	/**
	 */
	public NacDayButtonStylePreference(Context context, AttributeSet attrs, int style)
	{
