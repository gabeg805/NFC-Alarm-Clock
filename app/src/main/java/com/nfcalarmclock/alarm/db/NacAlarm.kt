...
class NacAlarm() : Comparable<NacAlarm>, Parcelable
{
	...
	class Builder()
	{
		...
		constructor(shared: NacSharedPreferences?) : this()
		{
			if (shared != null)
			{
				this.setDays(NacCalendar.Days.valueToDays(shared.days))
	...
	{
		days = NacCalendar.Days.valueToDays(value)
	}
	...
	{
		// Get today's day
		val day = NacCalendar.Days.getToday()
	...
	override fun writeToParcel(output: Parcel, flags: Int)
	{
		...
		output.writeInt(NacCalendar.Days.daysToValue(days))
