package com.nfcalarmclock.colorpicker;
 ...
 */
public class NacColorPickerPreference
	extends Preference
		...
		NacDialog.OnNeutralActionListener
{
	...
	/**
	 */
	public NacColorPickerPreference(Context context, AttributeSet attrs)
	{
	...
	/**
	 */
	public NacColorPickerPreference(Context context, AttributeSet attrs, int style)
	{
